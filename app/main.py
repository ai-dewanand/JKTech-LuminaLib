...
from app.api.v1.borrow import borrow_router
...
app.include_router(borrow_router, prefix="/borrow", dependencies=[Depends(verify_token)])
app.include_router(review_router, prefix="/reviews", dependencies=[Depends(verify_token)])
